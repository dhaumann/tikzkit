...
#ifndef TIKZ_UNDO_SET_ELLIPSE_ANCHOR_H
#define TIKZ_UNDO_SET_ELLIPSE_ANCHOR_H
...
class UndoSetEllipseAnchor : public UndoItem
{
    public:
         ...
         * Constructor.
         */
        UndoSetEllipseAnchor(qint64 pathId, Anchor newAnchor, Document * doc);

        /**
         * Destructor
         */
        virtual ~UndoSetEllipseAnchor();
