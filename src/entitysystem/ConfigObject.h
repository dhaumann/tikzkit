...
#ifndef ENTITY_SYSTEM_CONFIG_OBJECT_H
#define ENTITY_SYSTEM_CONFIG_OBJECT_H
 ...
 * @TODO FIXME
 */
class ES_EXPORT ConfigObject : public QObject
{
    Q_OBJECT
...
class ES_EXPORT ConfigTransaction
{
public:
...
#endif // ENTITY_SYSTEM_CONFIG_OBJECT_H
