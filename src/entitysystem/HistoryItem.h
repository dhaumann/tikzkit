...
#ifndef ENTITY_SYSTEM_HISTORY_ITEM_H
#define ENTITY_SYSTEM_HISTORY_ITEM_H
...
public:
     ...
     */
    HistoryItem(const QString & text, Document* doc);
     ...
     */
    virtual bool mergeWith(const HistoryItem * item);
...
private:
     ...
     */
    HistoryItemPrivate * const d;
};

}

#endif // ENTITY_SYSTEM_HISTORY_ITEM_H
