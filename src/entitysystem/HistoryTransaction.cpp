...
HistoryTransaction::HistoryTransaction(Document *document)
    : HistoryTransaction(document, QString())
{
}

HistoryTransaction::HistoryTransaction(Document * document, const QString & name)
    : m_document(document)
{
...
void HistoryTransaction::cancel()
{
    if (m_document) {
...
void HistoryTransaction::finish()
{
    if (m_document) {
...
bool HistoryTransaction::isRunning() const
{
