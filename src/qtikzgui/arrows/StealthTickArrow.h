#ifndef TIKZGUI_STEALTH_TICK_ARROW_H
#define TIKZGUI_STEALTH_TICK_ARROW_H
...
{
    public:
        StealthTickArrow(tikz::EdgeStyle* style);
...
{
public:
    ReversedStealthTickArrow(tikz::EdgeStyle * style);
...
#endif // TIKZGUI_STEALTH_TICK_ARROW_H
