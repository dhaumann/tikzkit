...
#ifndef TIKZ_UI_LATEX_ARROW_H
#define TIKZ_UI_LATEX_ARROW_H
...
{
    public:
        LatexArrow(tikz::core::EdgeStyle* style);
        virtual ~LatexArrow();
...
{
    public:
        ReversedLatexArrow(tikz::core::EdgeStyle * style);
