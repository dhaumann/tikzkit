...
#ifndef TIKZ_UI_STEALTH_ARROW_H
#define TIKZ_UI_STEALTH_ARROW_H
...
{
    public:
        StealthArrow(tikz::core::Style* style);
...
{
public:
    ReversedStealthArrow(tikz::core::Style * style);
