...
#ifndef TIKZ_UNDO_CONNECT_ELLIPSE_H
#define TIKZ_UNDO_CONNECT_ELLIPSE_H
...
class UndoConnectEllipse : public UndoItem
{
    public:
         ...
         * Constructor.
         */
        UndoConnectEllipse(qint64 pathId, qint64 nodeId, Document * doc);

        /**
         * Destructor
         */
        virtual ~UndoConnectEllipse();
